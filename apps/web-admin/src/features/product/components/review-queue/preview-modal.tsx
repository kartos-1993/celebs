                    ...
                    <div className="p-4 border-b bg-muted/20 flex flex-wrap items-center justify-between gap-3">
                            ...
                            <div className="flex items-center gap-3 text-xs text-muted-foreground mt-1">
                                <span>
                                    ...
                                    <strong className="text-foreground">
                                        {product.vendorName || 'Independent'}
                                    </strong>
                                </span>
                                <span>•</span>
                                <span>
                        ...
                        <div className="flex items-center bg-muted rounded-lg p-1 border">
                            <button
                                ...
                                className={`flex items-center gap-1.5 px-3 py-1 text-xs font-medium rounded-md transition-all ${previewDevice === 'desktop'
                            ...
                            <button
                                ...
                                className={`flex items-center gap-1.5 px-3 py-1 text-xs font-medium rounded-md transition-all ${previewDevice === 'mobile'
                                        ? 'bg-background text-foreground shadow-sm'
                                        : 'text-muted-foreground hover:text-foreground'
                                    }`}
                            >
                        ...
                        {PREVIEW_TABS.map((tab) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex items-center gap-1.5 px-4 py-3 border-b-2 transition-colors whitespace-nowrap ${isActive
                                        ...
                                        <div className="flex gap-2 overflow-x-auto py-1">
                                            {(product.mainImages ?? []).map((imageUrl, index) => (
                                                <button
                                                    ...
                                                    className={`h-16 w-16 rounded-md overflow-hidden border-2 transition-all ${activePreviewImage === imageUrl
