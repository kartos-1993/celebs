...
import { useProductMutations, useProductsQuery, useReviewQueueQuery } from '../../hooks/use-product-queries';
            ...
            <Card>
                ...
                <CardContent>
                    {activeQuery.isLoading ? (
                        ...
                        <div className={`overflow-x-auto ${activeQuery.isFetching ? 'opacity-60' : ''} transition-opacity`}>
                            <Table>
                                <TableHeader>
                                    <TableRow>
