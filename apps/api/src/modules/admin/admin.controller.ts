...
export class AdminController {
  ...
  // Vendor Management
  public getAllVendors = asyncHandler(async (req: Request, res: Response): Promise<any> => {
  ...
  public getVendorById = asyncHandler(async (req: Request, res: Response): Promise<any> => {
    const { id } = req.params;
  ...
  public approveVendor = asyncHandler(async (req: Request, res: Response): Promise<any> => {
    const { id } = req.params;
  ...
  public rejectVendor = asyncHandler(async (req: Request, res: Response): Promise<any> => {
    const { id } = req.params;
  ...
  public suspendVendor = asyncHandler(async (req: Request, res: Response): Promise<any> => {
    const { id } = req.params;
  ...
  // User Management
  public getAllUsers = asyncHandler(async (req: Request, res: Response): Promise<any> => {
  ...
  public createUser = asyncHandler(async (req: Request, res: Response): Promise<any> => {
  ...
  public deleteUser = asyncHandler(async (req: Request, res: Response): Promise<any> => {
    const { id } = req.params;
