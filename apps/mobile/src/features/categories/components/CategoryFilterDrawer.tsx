...
export const SIZE_OPTIONS = ['XS', 'S', 'M', 'L', 'XL', 'XXL', '28', '30', '32', '34', '36', '38'];
export const FIT_OPTIONS = ['Loose', 'Oversized', 'Regular Fit', 'Slim Fit', 'Wide Leg', 'Straight Leg'];
export const STYLE_OPTIONS = ['Streetwear', 'Vintage', 'Casual - Modern Casual', 'Avant-Garde', 'Amekaji'];
